namespace GirlyMerely.Infrastructure.Migrations
{
    ...
    public partial class sdsdq : DbMigration
    {
        public override void Up()
        {
            ...
            CreateTable(
                ...
                c => new
                    {
                        Id = c.Int(nullable: false, identity: true),
                        ShippingPriceAmount = c.Long(nullable: false),
                        ShipingDate = c.DateTime(nullable: false),
                        ShipingStatus = c.Boolean(nullable: false),
                ...
                .ForeignKey("dbo.ShippingPrices", t => t.ShippingPriceId)
                .Index(t => t.CustomerId)
                .Index(t => t.GeoDivisionId)
                .Index(t => t.DiscountCodeId)
                .Index(t => t.ShippingPriceId);
                ...
                c => new
                    {
                        ...
                        SaleRefrenceID = c.Int(nullable: false),
            ...
            CreateTable(
                ...
                c => new
                    {
                        Id = c.Int(nullable: false, identity: true),
                        MaxCartOverallPrice = c.Long(nullable: false),
                        ShippingPriceValue = c.Long(nullable: false),
                        Description = c.String(),
                        InsertUser = c.String(),
                        InsertDate = c.DateTime(),
                        UpdateUser = c.String(),
        ...
        public override void Down()
        {
            ...
            DropForeignKey("dbo.Invoices", "ShippingPriceId", "dbo.ShippingPrices");
            ...
            DropIndex("dbo.Invoices", new[] { "ShippingPriceId" });
